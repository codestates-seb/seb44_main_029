...
|   Role    |                                                                              - 로그인 / 회원가입 페이지 <br> - 로그아웃, 회원탈퇴 <br> - 마이페이지 <br> - 공통 컴포넌트 <br> (Input, Button, Footer) <br> - 랜딩 페이지 <br> - AWS S3 배포 <br>                                                  |        - 테마 아이템 리스트 <br> - 페이지네이션(무한 스크롤) <br> - 좋아요 기능 <br> - 좋아요 리스트 필터링 <br> - 상세 이미지 페이지 <br> - 에러 페이지                                                                                                                |                                               - 회원가입    <br>- 로그인, 로그아웃 <br> 일반 / 구글 / 게스트 로그인 <br> - 프로필 페이지 <br> 회원 정보 조회 / 탈퇴 <br> 좋아요 리스트 조회 / 업데이트 
